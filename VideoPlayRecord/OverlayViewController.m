...
- (void)viewDidLoad
{
    ...
    self.segmentedControl = [[UISegmentedControl alloc] initWithItems:[NSMutableArray arrayWithObjects:@"1",@"2",@"3",nil]];
...
-(void)applyVideoEffectsToComposition:(AVMutableVideoComposition *)composition size:(CGSize)size
{
    ...
    if (self.segmentedControl.selectedSegmentIndex == 0) {
        overlayImage = [UIImage imageNamed:@"Circles"];
    } else if(self.segmentedControl.selectedSegmentIndex == 1) {
        overlayImage = [UIImage imageNamed:@"Squares"];
    } else if(self.segmentedControl.selectedSegmentIndex == 2) {
        overlayImage = [UIImage imageNamed:@"Mask"];
    }
